    ...
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[250px]">
        ...
        <motion.div 
          ...
          className="col-span-1 md:col-span-2 lg:col-span-2 row-span-1 bg-meshark-slate/40 border border-meshark-blue/50 rounded-3xl p-8 flex flex-col justify-between backdrop-blur-sm subtle-glow overflow-hidden relative group"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-meshark-cyan/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          <div className="relative z-10 flex items-center gap-3 mb-4">
            <Terminal className="w-6 h-6 text-meshark-cyan" />
          ...
          <div className="flex gap-4 relative z-10 flex-wrap">
             <span className="px-3 py-1 bg-black/50 border border-meshark-slate rounded-md text-xs font-mono text-meshark-cyanLight">React</span>
             <span className="px-3 py-1 bg-black/50 border border-meshark-slate rounded-md text-xs font-mono text-meshark-cyanLight">TypeScript</span>
             <span className="px-3 py-1 bg-black/50 border border-meshark-slate rounded-md text-xs font-mono text-meshark-cyanLight">Python</span>
             <span className="px-3 py-1 bg-black/50 border border-meshark-slate rounded-md text-xs font-mono text-meshark-cyanLight">Linux</span>
          </div>
        </motion.div>
        ...
        <motion.div 
          whileHover={{ y: -5 }}
          className="col-span-1 md:col-span-1 lg:col-span-1 row-span-1 bg-meshark-slate/40 border border-meshark-blue/50 rounded-3xl p-8 flex flex-col justify-between backdrop-blur-sm group"
        >
          <div className="flex items-center gap-3">
            <ShieldCheck className="w-6 h-6 text-meshark-cyan" />
          ...
          <div className="w-full h-1 bg-meshark-slate mt-auto rounded-full overflow-hidden">
            <div className="h-full bg-meshark-cyan w-3/4" />
          </div>
        </motion.div>
        ...
        <motion.div 
          whileHover={{ scale: 0.98 }}
          className="col-span-1 md:col-span-2 lg:col-span-1 row-span-2 bg-meshark-slateDark border border-meshark-blue rounded-3xl p-8 flex flex-col backdrop-blur-sm relative overflow-hidden group"
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-meshark-cyan/20 rounded-full blur-3xl -mr-10 -mt-10" />
          <div className="flex flex-col h-full relative z-10">
            <h2 className="text-xl font-bold text-white mb-6">Beyond The Code</h2>
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-meshark-slate flex items-center justify-center shrink-0 border border-meshark-blue">
                  <span className="text-meshark-cyan font-bold">🥋</span>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-meshark-slate flex items-center justify-center shrink-0 border border-meshark-blue">
                  <Database className="w-4 h-4 text-meshark-cyanLight" />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-meshark-slate flex items-center justify-center shrink-0 border border-meshark-blue">
                  <Globe className="w-4 h-4 text-meshark-cyanLight" />
                </div>
                <div>
        ...
        <motion.div 
          whileHover={{ y: -5 }}
          className="col-span-1 md:col-span-1 lg:col-span-1 row-span-1 bg-meshark-cyan/10 border border-meshark-cyan/30 rounded-3xl p-8 flex flex-col justify-between backdrop-blur-sm group"
        >
          <div className="flex items-center gap-3">
            <Code2 className="w-6 h-6 text-meshark-cyanLight" />
            <h3 className="text-lg font-bold text-white leading-tight">AI-CV-Builder</h3>
          </div>
          <p className="text-meshark-silver text-sm mt-4">
            Automated JS/Python resume engine.
          </p>
          <button className="mt-4 text-left text-xs font-mono text-meshark-cyanLight group-hover:text-white transition-colors flex items-center gap-1">
        ...
        >
          <div className="flex items-center gap-3">
            <Layout className="w-6 h-6 text-meshark-cyan" />
          ...
          <div className="w-full h-1 bg-meshark-slate mt-auto rounded-full overflow-hidden">
            <div className="h-full bg-meshark-cyan w-1/2" />
          </div>
        </motion.div>
        ...
        <motion.div 
          whileHover={{ scale: 0.98 }}
          className="col-span-1 md:col-span-1 lg:col-span-1 row-span-1 bg-meshark-slate/40 border border-meshark-blue/50 rounded-3xl p-8 flex flex-col justify-center backdrop-blur-sm group items-center text-center"
        >
          <Server className="w-8 h-8 text-meshark-cyan mb-4" />
